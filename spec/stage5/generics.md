# Akvila Generics — Stage 5.2 Specification

## Overview

Akvila generics use monomorphization — each concrete instantiation generates specialized code. No runtime type erasure. No virtual dispatch for generics.

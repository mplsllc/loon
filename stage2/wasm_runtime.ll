; Akvila WASM Runtime — linked with compiler output for WASM self-hosting
; Provides: _akvila_i64_to_str, _akvila_print_byte, _akvila_read_file, _akvila_get_arg
...
; For WASM, int_to_string uses _akvila_i64_to_str instead
...
; --- _akvila_i64_to_str: convert i64 to null-terminated decimal string ---
; Simpler approach: write digits right-to-left, then return pointer to first digit
define i8* @_akvila_i64_to_str(i64 %val) {
entry:
...
; --- _akvila_print_byte: write single byte to stdout ---
@_pb = global [1 x i8] zeroinitializer
define void @_akvila_print_byte(i64 %ch) {

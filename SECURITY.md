...
Akvila is pre-1.0. The language exists because security should be structural, not aspirational — privacy types, effect declarations, and exhaustive matching are core to the compiler, not bolted on. If any of that is broken, I want to know immediately.
...
- Steps to reproduce (a `.akvila` file that triggers it is ideal)
...
- Feature requests — use [GitHub Issues](https://github.com/mplsllc/akvila/issues)
...
- The Akvila compiler (all stages)
